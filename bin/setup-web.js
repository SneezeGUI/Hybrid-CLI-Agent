#!/usr/bin/env node
/**
 * Web-based Setup GUI for Gemini Worker MCP Server
 *
...
<head>
  ...
  <title>Gemini Worker MCP Server - Setup</title>
  <style>
...
<body>
  <div class="container">
    <header>
      <h1>🤖 Gemini Worker MCP Server</h1>
    ...
    req.on('end', () => {
      try {
        ...
        if (data.registerClaude === 'on') {
          registerWithClaude();
          message += '<br>✅ Registered with Claude Code.<br><br>🔄 Restart Claude Code to apply changes.';
        }
        ...
        // Shutdown after save
        setTimeout(() => {
          console.log('\n✅ Configuration saved. Shutting down setup server.');
          process.exit(0);
        }, 1000);
      } catch (err) {
...
server.listen(PORT, () => {
  ...
  console.log(`
╔══════════════════════════════════════════════════════════════╗
║       Gemini Worker MCP Server - Web Setup                   ║
╠══════════════════════════════════════════════════════════════╣
